            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                            ...
                            @if(file_exists('img/hobbies/' . $hobby->id . '_large.jpg'))
                                <div class="mb-2 d-flex justify-content-between align-items-center">
                                    <img
                                        ...
                                        src="/img/hobbies/{{ $hobby->id }}_large.jpg"
                                        alt="">
                                    <a class="btn btn-outline-danger" href="/hobby/{{ $hobby->id }}/delete-images">Delete Images</a>
                                </div>
                            @endif
                        ...
                        <a class="btn btn-primary float-right" href="/hobby"><i
